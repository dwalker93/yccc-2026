...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        `group/input-group relative flex h-[38px] w-full min-w-0 items-center
        rounded-4xl border border-input bg-input/30 transition-colors
        ...
        has-[textarea]:rounded-xl has-[>[data-align=block-end]]:h-auto
