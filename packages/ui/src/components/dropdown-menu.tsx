    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          overflow-x-hidden overflow-y-auto rounded-lg bg-popover/70 p-1
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        py-1.5 pr-8 pl-2 text-xs outline-hidden select-none focus:bg-accent
        focus:text-accent-foreground focus:**:text-accent-foreground
        data-inset:pl-7.5 data-disabled:pointer-events-none
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        text-xs outline-hidden select-none focus:bg-accent
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        origin-(--radix-dropdown-menu-content-transform-origin) animate-none!
        overflow-hidden rounded-lg bg-popover/70 p-1 text-popover-foreground
