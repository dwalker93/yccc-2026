...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        `mb-2 font-medium data-[variant=label]:text-xs/relaxed
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        has-data-checked:bg-primary/5 has-[>[data-slot=field]]:rounded-md
        has-[>[data-slot=field]]:border *:data-[slot=field]:p-2
  ...
  return (
    <p
      ...
      className={cn(
        ...
        text-muted-foreground group-has-data-horizontal/field:text-balance
