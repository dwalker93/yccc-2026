...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        `flex w-fit items-center justify-between gap-1.5 rounded-4xl border
        border-input bg-input/30 px-3 py-2 text-sm whitespace-nowrap
        ...
        *:data-[slot=select-value]:gap-1.5 dark:hover:bg-input/50
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          animate-none! overflow-x-hidden overflow-y-auto rounded-2xl
          bg-popover/70 text-popover-foreground shadow-2xl ring-1
          ring-foreground/5 duration-100 before:pointer-events-none
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        `relative flex w-full cursor-default items-center gap-2.5 rounded-xl
        py-2 pr-8 pl-3 text-sm outline-hidden select-none focus:bg-accent
