  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        justify-center gap-1.5 rounded-xl border border-transparent px-2 py-1
        ...
        disabled:opacity-50 has-data-[icon=inline-end]:pr-1.5
        has-data-[icon=inline-start]:pl-1.5 dark:text-muted-foreground
